 ...
 * Copyright (c) 2009-2011 by formation, Inc. All Rights Reserved.
...
//@interface formationObject : NSObject
//@end

@interface formationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[formationObject class]])
		{
			for (NSString *key in [[(formationObject*)o modules] allKeys])
			{
