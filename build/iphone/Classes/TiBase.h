...
// in simulator we redefine to format for formation Developer console
...
{\
	NSString * exceptionName = [@"org.formation." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.formation";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIformationNativeItemNone = -1, 
	UIformationNativeItemSpinner = -2,
	UIformationNativeItemProgressBar = -3,
	
	UIformationNativeItemSlider = -4,
	UIformationNativeItemSwitch = -5,
	UIformationNativeItemMultiButton = -6,
	UIformationNativeItemSegmented = -7,
	
	UIformationNativeItemTextView = -8,
	UIformationNativeItemTextField = -9,
	UIformationNativeItemSearchBar = -10,
	
	UIformationNativeItemPicker = -11,
	UIformationNativeItemDatePicker = -12,
	
	UIformationNativeItemInfoLight = -13,
	UIformationNativeItemInfoDark = -14,
	
	UIformationNativeItemDisclosure = -15,
	
	UIformationNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all formation instances of
