...
@interface formationObject : KrollCoverageObject {
#else
@interface formationObject : KrollObject {
#endif
@private
...
extern NSString * formation$ModuleRequireFormat;
